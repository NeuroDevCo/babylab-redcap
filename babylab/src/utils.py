...
def fmt_new_button(record: str, ppt_id: str = None):
    ...
    button_str = '<button type="button" class="btn"><i class="fa-solid fa-language"></i></button></a>'
...
def fmt_modify_button(ppt_id: str = None, apt_id: str = None, que_id: str = None):
    ...
    Returns:
        str: Formatted HTML string.
    """  # pylint: disable=line-too-long
    button_str = '<button type="button" class="btn"><i class="fa-solid fa-pen"></i></button></a>'
