...
class TestRecordClass:
    ...
    def test_records_class_participants(self):
    ...
    def test_records_class_appointments(self):
    ...
    def test_records_class_questionnaires(self):
...
class TestRecordListClass:
    def test_recordlist_class_participants(self):
    ...
    def test_recordlist_class_appointments(self):
    ...
    def test_recordlist_class_questionnaires(self):
